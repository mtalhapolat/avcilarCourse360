...
<main class="main-content" style="text-align: -webkit-center!important">
    ...
    @if($enrollcheck == 1)
        <div class="login-container login-container-basvurularim" style="padding: 20px!important; margin-bottom: 2%" onclick="window.location.href='/yuvamiz-avcilar/basvurularim'">
    ...
    @if($enrollcheck == 0)
        <div class="login-container">
            <div class="logoo">
                ...
                <h1>Yuvamız Avcılar</h1>
            </div>


            <p style="text-align: center">Yuvamız Avcılar başvuruları tamamlanmıştır. Yoğun ilginize teşekkür ederiz.</p>
    ...
    <div id="kvkkModal" class="modal">
        <div class="modal-content">
            ...
            <p>Yuvamız Avcilar Anaokulları 2025-2026 Eğitim ve Öğretim dönemi ön başvuru süreci başlamıştır.</p>

            <p>2025-2026 yılı Eğitim ve Öğretim dönemi için Yuvamız Avcilar Anaokulları;
    ...
    <div id="kvkkModal2" class="modal">
        <div class="modal-content">
            ...
            <p>Yuvamız Avcilar’da 2025-2026 Eğitim Dönemi;</p>

            <p>Yuvamız Avcilar Anaokulları ihtiyaç sahibi ailelerin çocuklarının okul öncesi hizmetlerden yararlanmakta yaşadığı fırsat eşitsizliğini azaltmak için hayata geçirilmektedir. </p>
            ...
            <p>2025 - 2026 eğitim dönemi için arasında verilen hizmet karşılığı ücret, Avcilar Belediyesi Meclis Kararı ile;</p>
    ...
    <div id="kvkkModal3" class="modal">
        <div class="modal-content">
            ...
            <p>●     Hizmete ilişkin iş süreçlerinin yürütülmesi, hizmete ilişkin destek süreçlerinin yürütülmesi amacıyla Avcilar Belediyesi İştiraklerine,</p>
            ...
            <p>Kişisel verileriniz ile ilgili başvuru ve taleplerinizi dilerseniz Avcilar Belediyesi internet sitesinde yer alan İlgili Kişi Başvuru Formu aracılığıyla;</p>

            <p>●     Daha önce bildirilen ve belediye sistemlerinde kayıtlı bulunan e-posta adresinizi kullanmak suretiyle iletisim@avcilar.bel.tr adresine elektronik posta göndererek,</p>
            <p>●     Islak imzalı ve kimliğinizi tevsik edici belgeler ile Avcilar Belediyesi Avcilar - İSTANBUL adresine göndererek,</p>
            <p>●     Geçerli bir kimlik belgesi ile birlikte Avcilar Belediyesi’ne bizzat başvurarak,</p>
            <p>●     Mobil imza veya güvenli elektronik imza ile imzalayıp iletisim@avcilar.bel.tr adresine e-posta gönderilerek,</p>
            <p>●     Kayıtlı elektronik posta (KEP) adresi ve güvenli elektronik imza ya da mobil imza kullanmak suretiyle avcilarbelediyesi@hs01.kep.tr kayıtlı elektronik posta adresimize göndererek,</p>

            <p>Avcilar Belediyesi’ne iletebilirsiniz.</p>
                    ...
                    success: function (data) {
                        if (data === "kimlikhata") {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data === "true") {
                                        window.location.href="/yuvamiz-avcilar/basvurularim";
                            ...
                            window.location.href="/yuvamiz-avcilar/2?identity="+tcNo;
                        }
                    },
                    error: function(err) {
                        console.log( "kimlik sorgulamada hata" );
                        window.location.href="/yuvamiz-avcilar";
                        exit;
                        debugger;
                    }
                });
...
<script>
    ...
    document.querySelectorAll('.nav-item').item(4).classList.add('active');
