...
<main class="main-content">
    ...
    <h2 style="margin-bottom: 1rem; font-size: 1.5rem; font-weight: 600;">Mevcut Kurslar</h2>
    <p>Başvuruya açık toplam <b>{{$lessons->count()}}</b> kursumuz bulunmaktadır.</p> <br>
    ...
    @if($request->s != null) Tüm kursları listelemek için <a href="/basvuru">tıklayınız</a> <br> <br> @endif
...
<script>
    ...
    document.querySelectorAll('.nav-item').item(1).classList.add('active');
    ...
    const courses = [
            ...
            @if($request->s != null) @if($request->s != $lesson->lesson_id) @continue @endif @endif
        {
            id: {{$lesson->lesson_id}},
            name: "{{$lesson->branch}}",
            instructor: "{{$lesson->center}}",
            ...
            description: {!! json_encode($lesson->statement) !!},
        ...
        if(course.gender === 'Male' || course.gender === 'Female') {
            if (course.enrollcount < course.quota + course.addquota) {
                ...
                <div style="position: relative" class="course-card">
                    ...
                    <div class="course-instructor"><svg style="margin-bottom: -5px" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#e20303" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"/><circle cx="12" cy="10" r="3"/></svg> ${course.instructor}</div>
...
<img src="/calendar.png" width="25px" style="margin-bottom: -6px; margin-right: 5px" alt="">Ders Programı
<svg style="position:absolute; right: 1.5rem" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
</div>
...
<svg style="position:absolute; right: 1.5rem" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
    ...
    function openPopup(courseId) {
        ...
        if (course) {
            ...
            popupInstructor.innerHTML = course.instructor;
