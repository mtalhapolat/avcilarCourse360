...
<main class="main-content">
    ...
    <div class="form-container">
        ...
        <div style="text-align: center">
            <img src="kefken-gunubirlik.png" style="height: 100px" alt="">
        </div>
        <h1 class="formheader">Günübirlik Kefken Başvurusu</h1> <br>
        
        

        @if($enrollcount > 0)

            <p style="text-align: center">Kefken için 1 kere başvuru yapma hakkınız vardır. Adınıza daha önce yapılmış kefken başvurusu görünmektedir.</p>
        ...
        @elseif(\Carbon\Carbon::parse($student->birthday)->age < 18)
            ...
            <p style="text-align: center">Günübirlik kefken başvurusunu 18 yaşından büyük vatandaşlarımız yapabilir.</p>
        ...
        @else
            ...
            <form id="kefkenForm">
                ...
                <input type="hidden" id="student_gender" name="student_gender" value="{{$student->gender}}">
                <input type="hidden" id="student2_gender" name="student2_gender" value="">
                <input type="hidden" id="student3_gender" name="student3_gender" value="">
                <input type="hidden" id="student4_gender" name="student4_gender" value="">
                <input type="hidden" id="student5_gender" name="student5_gender" value="">
                <input type="hidden" id="student6_gender" name="student6_gender" value="">
                ...
                <div class="step" data-step="2">
                    <label for="student_count">Sizinle beraber başka katılacak kişi var mı?</label> <br>
                    <small><span style="color: red">Bilgi: </span> <span style="text-decoration:underline">Sizin dışınızda</span> beraber gelecek kişi sayısını giriniz. Çocuklarınız, anne, baba, kardeş, arkadaş vs.
                        <br> Başvurunuza başka kişi eklemek istemiyorsanız "Yok" seçeneğini seçiniz.</small>
                    <br>

                    <select class="selectform" name="student_count" id="student_count">
                ...
                <div class="step" data-step="3">
                    <h3>2. Kişi Bilgileri</h3>
                    <label for="student2_name">Adı:</label>
                    <input type="text" id="student2_name" name="student2_name" value=""  required>
                    <label for="student2_surname">Soyadı:</label>
                    <input type="text" id="student2_surname" name="student2_surname" value=""  required>
                    ...
                    <input type="text" id="student2_identity" name="student2_identity" pattern="\d{11}" value=""
                           title="11 haneli TC Kimlik Numarası" required>
                    <label for="student2_birthday">Doğum Tarihi:</label>
                    <input type="date" id="student2_birthday" name="student2_birthday" value=""  required>
                    <label for="student2_phone">Telefon (Varsa):</label>
                    <input type="text" id="student2_phone" name="student2_phone" pattern="\d{10}" placeholder="Başında sıfır olmadan 10 haneli telefon numarasını giriniz" value="" >
                    <label for="student2_info">Yakınlık Bilgisi</label>
                    <select class="selectform" name="student2_info" id="student2_info" required="required">
                        ...
                        <option value="arkadas">Arkadaşım</option>
                        <option value="diger">Diğer</option>
                    </select>
                </div>

                <div class="step" data-step="4">
                    <h3>3. Kişi Bilgileri</h3>
                    <label for="student3_name">Adı:</label>
                    <input type="text" id="student3_name" name="student3_name" value=""  required>
                    <label for="student3_surname">Soyadı:</label>
                    <input type="text" id="student3_surname" name="student3_surname" value=""  required>
                    <label for="student3_identity">Kimlik Numarası:</label>
                    <input type="text" id="student3_identity" name="student3_identity" pattern="\d{11}" value=""
                           title="11 haneli TC Kimlik Numarası" required>
                    <label for="student3_birthday">Doğum Tarihi:</label>
                    <input type="date" id="student3_birthday" name="student3_birthday" value=""  required>
                    <label for="student3_phone">Telefon (Varsa):</label>
                    <input type="text" id="student3_phone" name="student3_phone" pattern="\d{10}" placeholder="Başında sıfır olmadan 10 haneli telefon numarasını giriniz" value="" >
                    <label for="student3_info">Yakınlık Bilgisi</label>
                    <select class="selectform" name="student3_info" id="student3_info" required>
                        <option value="">Seçiniz</option>
                        <option value="cocuk">Çocuğum</option>
                        <option value="anne">Annem</option>
                        <option value="baba">Babam</option>
                ...
                <div class="step" data-step="5">
                    <h3>4. Kişi Bilgileri</h3>
                    <label for="student4_name">Adı:</label>
                    <input type="text" id="student4_name" name="student4_name" value=""  required>
                    <label for="student4_surname">Soyadı:</label>
                    <input type="text" id="student4_surname" name="student4_surname" value=""  required>
                    <label for="student3_identity">Kimlik Numarası:</label>
                    <input type="text" id="student4_identity" name="student4_identity" pattern="\d{11}" value=""
                           title="11 haneli TC Kimlik Numarası" required>
                    <label for="student4_birthday">Doğum Tarihi:</label>
                    <input type="date" id="student4_birthday" name="student4_birthday" value=""  required>
                    <label for="student4_phone">Telefon (Varsa):</label>
                    <input type="text" id="student4_phone" name="student4_phone" pattern="\d{10}" placeholder="Başında sıfır olmadan 10 haneli telefon numarasını giriniz" value="" >
                    <label for="student4_info">Yakınlık Bilgisi</label>
                    <select class="selectform" name="student4_info" id="student4_info" required>
                        <option value="">Seçiniz</option>
                        <option value="cocuk">Çocuğum</option>
                        <option value="anne">Annem</option>
                        <option value="baba">Babam</option>
                ...
                <div class="step" data-step="6">
                    <h3>5. Kişi Bilgileri</h3>
                    <label for="student5_name">Adı:</label>
                    <input type="text" id="student5_name" name="student5_name" value=""  required>
                    <label for="student5_surname">Soyadı:</label>
                    <input type="text" id="student5_surname" name="student5_surname" value=""  required>
                    <label for="student5_identity">Kimlik Numarası:</label>
                    <input type="text" id="student5_identity" name="student5_identity" pattern="\d{11}" value=""
                           title="11 haneli TC Kimlik Numarası" required>
                    <label for="student5_birthday">Doğum Tarihi:</label>
                    <input type="date" id="student5_birthday" name="student5_birthday" value=""  required>
                    <label for="student5_phone">Telefon (Varsa):</label>
                    <input type="text" id="student5_phone" name="student5_phone" pattern="\d{10}" placeholder="Başında sıfır olmadan 10 haneli telefon numarasını giriniz" value="" >
                    <label for="student5_info">Yakınlık Bilgisi</label>
                    <select class="selectform" name="student5_info" id="student5_info" required>
                        <option value="">Seçiniz</option>
                        <option value="cocuk">Çocuğum</option>
                        <option value="anne">Annem</option>
                        <option value="baba">Babam</option>
                ...
                <div class="step" data-step="7">
                    <h3>6. Kişi Bilgileri</h3>
                    <label for="student6_name">Adı:</label>
                    <input type="text" id="student6_name" name="student6_name" value=""  required>
                    <label for="student6_surname">Soyadı:</label>
                    <input type="text" id="student6_surname" name="student6_surname" value=""  required>
                    <label for="student6_identity">Kimlik Numarası:</label>
                    <input type="text" id="student6_identity" name="student6_identity" pattern="\d{11}" value=""
                           title="11 haneli TC Kimlik Numarası" required>
                    <label for="student6_birthday">Doğum Tarihi:</label>
                    <input type="date" id="student6_birthday" name="student6_birthday" value=""  required>
                    <label for="student6_phone">Telefon (Varsa):</label>
                    <input type="text" id="student6_phone" name="student6_phone" pattern="\d{10}" placeholder="Başında sıfır olmadan 10 haneli telefon numarasını giriniz" value="" >
                    <label for="student6_info">Yakınlık Bilgisi</label>
                    <select class="selectform" name="student6_info" id="student6_info" required>
                        <option value="">Seçiniz</option>
                        <option value="cocuk">Çocuğum</option>
                        <option value="anne">Annem</option>
                        <option value="baba">Babam</option>
...
<script>
    ...
    function nextPrev(n) {
        ...
        if(n === 1 && currentStep > 2) {
            var totalSteps = parseInt(document.getElementById('student_count').value)+2;
            $('#loading-spinner').show();
            identity = document.getElementById('student'+(currentStep-1)+'_identity').value;
            birthday = document.getElementById('student'+(currentStep-1)+'_birthday').value;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data === "kimlikhata") {
                    ...
                    } else if(data["town"] != "beyoğlu") {
                        alert("Kefken programı yalnızca Beyoğlu'nda ikamet eden vatandaşlarımız içindir. Anlayışınız için teşekkür ederiz.");
                        window.stop();
                    } else {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data === 'true') {
                                    ...
                                    if (parseInt(document.getElementById('student_count').value) === "0") {
                                        submitForm();
                                        return false;
                                    }
                        ...
                        document.getElementById('student'+(currentStep-1)+'_name').value = data['name'];
                        document.getElementById('student'+(currentStep-1)+'_surname').value = data['surname'];
                        document.getElementById('student'+(currentStep-1)+'_gender').value = data['gender'];
        ...
        } else if(parseInt(document.getElementById('student_count').value) === 0 && n === 1 && currentStep === 2) {
            $('#loading-spinner').show();
    ...
    function validateStep(step) {
        ...
        const inputs2 = step.querySelectorAll('select[required]');
