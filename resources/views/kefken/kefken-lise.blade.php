...
<main class="main-content">
    ...
    <div class="form-container">
        ...
        <div style="text-align: center">
            <img src="kefken-lise.png" style="height: 100px" alt="">
        </div>
        <h1 class="formheader">Lise Grubu Kefken Kampı Başvurusu</h1> <br>

        @if(\Carbon\Carbon::parse($student->birthday)->age < 21)

            <p style="text-align: center">Lise grubu için başvuruyu veli yapmalıdır. Başvuru yapmak için veli bilgileri ile uygulamaya giriş yapılmalıdır.</p>
        ...
        @else
            ...
            <form id="kefkenForm">
                ...
                <div class="step" data-step="2">
                    ...
                    <input type="text" id="student_phone" name="student_phone" value=""
                           pattern="\d{10}"
                           class="phone-input"
                           title="Telefon numarınızı başında sıfır olmadan giriniz">
                </div>
                    ...
                    <div class="radio-group" style="display: block">
                        <div class="radio-item kadin">
                            <input type="radio" id="visit_date" name="visit_date"
                                   value="2025-06-30" disabled>
                            <label for="visit_date">30 Haziran - 4 Temmuz (Doldu)</label>
                        </div>
                        <br>
                        <div class="radio-item kadin">
                        ...
                        <div class="radio-item erkek">
                            <input type="radio" id="visit_date3" name="visit_date"
                                   value="2025-08-11" disabled>
                            <label for="visit_date3">11 Ağustos - 14 Ağustos (Doldu)</label>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function nextPrev(n) {
        ...
        if(n === 1 && currentStep === 2 && (document.getElementById('student_birthday').value > '2011-12-31' || document.getElementById('student_birthday').value < '2007-01-01')){
            alert("Lise grubuna 14 - 18 yaş aralığındaki öğrenciler katılabilir.");
            exit;
        }
