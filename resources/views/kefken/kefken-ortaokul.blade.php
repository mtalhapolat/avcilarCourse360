...
<main class="main-content">
    ...
    <div class="form-container">
        ...
        <div style="text-align: center">
            <img src="kefken-ortaokul.png" style="height: 100px" alt="">
        </div>
        <h1 class="formheader">Ortaokul Grubu Kefken Kampı Başvurusu</h1> <br>

        @if(\Carbon\Carbon::parse($student->birthday)->age < 21)

            <p style="text-align: center">Ortaokul grubu için başvuruyu veli yapmalıdır. Başvuru yapmak için veli bilgileri ile uygulamaya giriş yapılmalıdır.</p>
        ...
        @else
            ...
            <form id="kefkenForm">
                ...
                <div class="step active" data-step="1">
                    ...
                    <input type="text" id="parent_name" name="parent_name" value="{{$student->name}}" required readonly>
                    <label for="parent_surname">Soyadı:</label>
                    <input type="text" id="parent_surname" name="parent_surname" value="{{$student->surname}}" required
                           readonly>
                    ...
                    <input type="date" id="parent_birthday" name="parent_birthday" value="{{$student->birthday}}"
                           required readonly>
                ...
                <div class="step" data-step="3">
                    ...
                    <div class="radio-group" style="display: block">
                        <div class="radio-item kadin">
                            <input type="radio" id="visit_date" name="visit_date"
                                   value="2025-06-23" disabled>
                            <label for="visit_date">23 Haziran - 27 Haziran (Doldu)</label>
                        </div>
                        <br>
                        <div class="radio-item kadin">
                            <input type="radio" id="visit_date2" name="visit_date"
                                   value="2025-08-04" disabled>
                            <label for="visit_date2">4 Ağustos - 8 Ağustos (Doldu)</label>
                        </div>
                        <br>
                        <div class="radio-item erkek">
                            <input type="radio" id="visit_date2" name="visit_date"
                                   value="2025-07-21" disabled>
                            <label for="visit_date2">21 Temmuz - 24 Temmuz (Doldu)</label>
                        </div>
                    </div>
                </div>
            ...
            <div style="margin-top: 5%">
                ...
                <p>Başvuru, öğrencinin velisi tarafından yapılmalıdır.</p>
            </div>
...
<script>
    ...
    function nextPrev(n) {
        ...
        if(n === 1 && currentStep === 2 && (document.getElementById('student_birthday').value > '2015-12-31' || document.getElementById('student_birthday').value < '2011-01-01')){
            alert("Ortaokul grubuna 10 - 14 yaş aralığındaki öğrenciler katılabilir.");
            exit;
        }
        ...
        if(n === 1 && currentStep === 2) {
            ...
            phoneInput = document.getElementById('student_phone');
            let token = '@csrf';
            token = token.substr(42, 40);
            $.ajax({
                type: "post",
                ...
                success: function (data) {
                    ...
                    if (data === "kimlikhata") {
                        ...
                        if (document.getElementById('student_gender').value === "1") {
                            document.querySelectorAll('.kadin').forEach(element => {
                                element.style.display = 'none';
                            });
                            document.querySelectorAll('.erkek').forEach(element => {
                                element.style.display = 'flex';
                            });
                        } else if (document.getElementById('student_gender').value === "2") {
                            document.querySelectorAll('.erkek').forEach(element => {
                                element.style.display = 'none';
                            });
                            document.querySelectorAll('.kadin').forEach(element => {
            ...
            phoneInput = document.getElementById('parent_phone');
