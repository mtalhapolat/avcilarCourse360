...
<main class="main-content">
    <header class="header">
        <div style="display: flex; align-items: center; gap: 1.5rem;">
            ...
            <div>
                <h1 class="pageheader">Spor Başvurusu</h1>
    ...
    <h2 style="margin-bottom: 1rem; font-size: 1.5rem; font-weight: 600;">Spor Kursları ve Etkinlikleri</h2>
    <p>Başvuruya açık toplam <b>{{$events->count()+$lessons->count()}}</b> spor kursu ve etkinliğimiz bulunmaktadır.</p> <br>
    ...
    @if($request->s != null) Tüm kurs / etkinlikleri listelemek için <a href="/sports">tıklayınız</a> <br> <br> @endif
